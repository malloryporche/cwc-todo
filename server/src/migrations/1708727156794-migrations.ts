...
export class Migrations1708727156794 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "project_tags" ("tagId" integer NOT NULL, "projectId" integer NOT NULL, CONSTRAINT "PK_348a788aabc2b5440dbc0153f60" PRIMARY KEY ("tagId", "projectId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "todo_tags" ("tagId" integer NOT NULL, "todoId" integer NOT NULL, CONSTRAINT "PK_85708ac82b6de1d0e2015e5862e" PRIMARY KEY ("tagId", "todoId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_72ad52a390ac887fbf9eb9215d" ON "todo_tags" ("tagId") `);
        await queryRunner.query(`CREATE INDEX "IDX_da0fd6bf7150f085b3e79f066f" ON "todo_tags" ("todoId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_da0fd6bf7150f085b3e79f066f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_72ad52a390ac887fbf9eb9215d"`);
